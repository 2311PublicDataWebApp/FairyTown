...
<body>
	...
	<main id="main" class="login-form container">
        <h2 class="mt-5" style="margin-left:50px;">LOGIN</h2>
        ...
        <form action="/user/login.ft" style="" method="post" name="loginForm" class="mt-3">
            ...
            <button type="submit" name="login" style="margin-top:50px; margin-left:60px;"class="btn btn-primary btn-lg">LOGIN</button>
        </form>
        <div class="mt-3">
