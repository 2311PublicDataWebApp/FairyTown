...
<body>
	...
	<div class="content-wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">티켓 수정</li>
							</ol>
						</div>
						<!-- breadcrumb -->
					</div>
			...
			<section class="content">
				<div class="container-fluid">
					<div class="row">
						...
						<input type="hidden" name="ticketImgNo"
							value="${ticket.ticketImgNo }"> <input type="hidden"
							name="ticketImgName" value="${ticket.ticketImgName }"> <input
							type="hidden" name="ticketImgRename"
							value="${ticket.ticketImgRename }"> <input type="hidden"
							name="ticketImgFilepath" value="${ticket.ticketImgFilepath }">
						<input type="hidden" name="ticketImgFilelength"
							value="${ticket.ticketImgFilelength }">
						<!-- left column -->
						<div class="col-md-10">
							<div class="card card-secondary">
								<div class="card-header">
									<h3 class="card-title">티켓 수정</h3>
								</div>
								<div class="card-body">
									<div class="row">
										<div class="col-sm-10">
											<div class="form-group">
												<table class="table_close">
													<tr>
														<td>
															<div class="form-group row">
																<label class="col-sm-3 col-form-label">티켓명 <sup
																	style="color: red">*</sup>
																</label>
																<div class="col-sm-9">
													...
													<tr>
														<td>
															<div class="form-group row">
																<label class="col-sm-3 col-form-label">티켓설명</label>
																<div class="col-sm-12">
													...
													<tr>
														<td>
															<div class="form-group row">
																<label class="col-sm-3 col-form-label">제휴카드 </label>
																<div class="col-sm-7">
																	<input type="text" class="form-control"
																		name="ticketCard" value="${ticket.ticketCard }"
															...
															<div class="form-group row">
																...
																<div class="col-sm-7">
																	<input type="number" class="form-control"
																		name="ticketAdult" value="${ticket.ticketAdult }"
																		value="10000"  oninput="this.value = Math.max(0, this.value)">
																</div>
															</div>
														</td>
													...
													<tr>
														<td>
															<div class="form-group row">
																<label class="col-sm-4 col-form-label">청소년 가격
																</label>
																<div class="col-sm-7">
																	<input type="number" class="form-control"
																		name="ticketTeen" value="${ticket.ticketTeen }"
																		value="10000"  oninput="this.value = Math.max(0, this.value)">
																</div>
															</div>
														</td>
													...
													<tr>
														<td>
															<div class="form-group row">
																<label class="col-sm-4 col-form-label">어린이 가격
																</label>
																<div class="col-sm-7">
																	<input type="number" class="form-control"
																		name="ticketChild" value="${ticket.ticketChild }"
																		value="10000" oninput="this.value = Math.max(0, this.value)">
																</div>
															</div>
														</td>
													...
													<tr>
														<td>
															<div class="form-group">
																<label class="col-sm-3 col-form-label">사용상태</label>
													...
													<tr>
														<td>
															<div class="input-group">
																<label for="InputFile">이미지</label>
															</div>
														</td>
													</tr>
													<tr>
														<td><img
															src="../resources/nuploadFiles/${ticket.ticketImgRename }"
															alt="티켓 이미지"></td>
													</tr>
													<tr>
														<td>
															<div class="custom-file">
																<div class="input-group-append">
																	<input type="file" class="custom-file-input"
																		name="reloadFile" id="exampleInputFile"> <label
																		class="custom-file-label" for="exampleInputFile">파일을
																		등록해주세요</label> <span class="input-group-text">Upload</span>
																</div>
															</div>
													...
													<tr>
														<td colspan="5"><br> <input type="button"
															...
															onclick="deleteTicket(${ticket.ticketNo});"></td>
													</tr>
												</table>
											</div>
										</div>
		...
		<!-- Bootstrap 4 -->
		<script
			src="../resources/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
		<!-- Select2 -->
